...
#tavs_saraksts = ['karstmaize','brauniji','kafija']
...
#kā šo kodu var uzrakstīt ar mazāk rindiņām? Vai ir vienkāršāks veids kā atrast vārda garumu?

krasass = ['zils','zaļš','dzeltens','balts']
for krasa in krasass:
    print(len(krasa))
